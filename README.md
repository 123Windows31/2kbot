...
3.存储库位置填https://github.com/123Windows31/2kbot.git

4.点击克隆

## 注意事项

因3.1bot使用到的依赖库执行**AGPLv3**开源协议，按照该开源协议的要求，3.1bot也将同步执行；所有将3.1bot代码片段投入线上使用的项目，都将需要**开源**并执行**AGPLv3**协议（参照该开源协议的“**网络使用即分发**”原则），谢谢配合！
